...
@Component({
  ...
  template: `
    <div>
      <div class="modal-lg-dialog" style="    margin: 0px;">
        <div class="modal-content" style="border: none !important;">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="    font-size: 20px;">Car Creation</h5>
      ...
      margin-top: 8px;
      margin-bottom: -10px;" [(ngModel)]="this.over25" class="example-margin">Over 25</mat-checkbox>
                    </section>
                  </div>
                  <div class="col" style="min-width: 100px; padding: 0px;">
                    <section class="example-section" style="    display: flex;">
                      <mat-checkbox color="warn" style="    margin: auto;
      margin-top: 8px;
      margin-bottom: -10px;" [(ngModel)]="this.disabled" class="example-margin">Disabled</mat-checkbox>
                    </section>
                  </div>
                </div>
                <div class="custom-file" style="    margin-top: 15px;margin-bottom: 10px">
...
export class AdminCreateCarComponent implements OnInit {
  ...
  createCar(): void {
    ...
    console.log(this.carType, this.colour, this.fuelType, this.gearType, this.size, this.seats, this.price, this.description, this.disabled);

    this.adminService.CreateCar(this.carType, this.colour, this.fuelType, this.gearType, this.size, this.seats, this.price,
      this.description,
      this.disabled, this.over25,

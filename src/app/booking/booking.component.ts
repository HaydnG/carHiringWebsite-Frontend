...
@Component({
  ...
  template: `
    <div class="modal-header" xmlns="http://www.w3.org/1999/html">
      ...
      font-size: 30px;">Booking</h5>
        ...
        <div style="font-size: 13px;
         color: #bf5c5c;
      text-align: center;" class="row" *ngIf="this.data.nextDayBooked.value"> The next day has a booking, and so this booking requires an
          early return.
    ...
    position: relative;
    font-weight: 600;">Collection Date:
            </div>
        ...
        margin-bottom: 5px;">
            ...
            <div style="    text-align: center;margin-top: 7px;">
              <div style=" margin-left: 5px;display: inline;font-weight: 700;">
                Return: {{this.toolService.getTimeString(this.data.fullDay.value, this.data.lateReturn.value, this.data.nextDayBooked.value)}}
              </div>
            </div>
            ...
            <div class="row" placement="bottom" [disableTooltip]="!this.data.nextDayBooked.value" [ngbTooltip]="nextday">
              <div [disableTooltip]="this.data.nextDayBooked.value" placement="bottom" class="col"
                   style="    text-align: center;margin-top: 7px;" [ngbTooltip]="fullDayTIPbooking">
                <ng-template #fullDayTIPbooking>Increase last day to the full duration</ng-template>
                <input [disabled]="this.data.lateReturn.value || this.data.nextDayBooked.value" id="checkbox_fullDay_booking"
                       type="checkbox" [(ngModel)]="this.data.fullDay.value">
                <label class="checklabel" for="checkbox_fullDay_booking" style="    margin-bottom: 0px;">Full Day</label>
              </div>
              <div [disableTooltip]="this.data.nextDayBooked.value" placement="bottom" class="col"
                   style="    text-align: center;margin-top: 7px;" *ngIf="this.userService.repeat" [ngbTooltip]="tipContentbooking">
                <input [disabled]="this.data.nextDayBooked.value" id="checkbox_late_booking" type="checkbox"
                       [(ngModel)]="this.data.lateReturn.value">
...
export class BookingComponent implements OnInit, OnDestroy {
  ...
  constructor(private calendar: NgbCalendar, public userService: UserService, private activeModal: NgbActiveModal,
              ...
              private router: Router, public toolService: ToolsService) {
